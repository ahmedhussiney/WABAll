  ...
  function(declare, Color, html, lang, array, xhr,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      startup: function() {
        ...
        def.then(lang.hitch(this, function() {
          if (!this.config.vizLayer || this.config.vizFields.length === 0) {
            this.panelContent.innerHTML = "<p align='center'>" + this.nls.viz_error + "</p>";
          } else {
            this._initUI();
            this._initLayers();
            this._initViz();
      ...
      onAppConfigChanged: function(appConfig, reason, changedData) {
        switch (reason) {
          ...
          case 'layoutChange':
            ...
            break;
          case 'styleChange':
            if(appConfig.theme.customStyles) {
              var color = appConfig.theme.customStyles.mainBackgroundColor;
      ...
      _removeFxLayer: function() {
        if (this.fxLayer) {
          this.sceneView.map.remove(this.fxLayer);
      ...
      _setVizPage: function(num) {
        this._featuresLoadedDfd.then(function() {
          ...
          setTimeout(lang.hitch(this, this._processViz), 300);
        }.bind(this));
      },
      ...
      _featureSelection: function(obj) {
        if (obj.data) {
          ...
          if(this.fxLayer && gra.geometry.type === "point") {
